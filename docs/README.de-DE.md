...
Die Verzögerung automatischer Warnungen beträgt standardmäßig 1,5 Sekunden und kann im Fenster Accessible OBS Studio als Dezimalwert geändert werden. Ausgangswarnungen bewerten den Pegel nach dem OBS-Regler. Warnungen vor dem Regler gelten nur für Live-Eingänge wie Mikrofone, Soundkarten und Anwendungsaudio, nicht für direkt von OBS wiedergegebene Medien. Der Dialog fragt, ob der Pegel vor dem Regler angepasst werden soll. Nein oder Escape deaktiviert nur diese Prüfung; Ausgangswarnungen und Konsolentöne bleiben aktiv. Solange die Lautstärkekonsole geöffnet ist, sind alle automatischen Warntöne und ihre Zeitzähler ausgesetzt; nur die fokussierte Quelle erzeugt Messsignale. Tief bedeutet: Live-Eingang vor dem Regler rot. Mittel bedeutet: fokussierte Quelle gelb. Hoch bedeutet: fokussierte Quelle rot oder automatische Ausgangswarnung.
