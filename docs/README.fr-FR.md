...
Les tonalités automatiques sont des avertissements, pas des mesures. Les avertissements de sortie évaluent le niveau après le curseur OBS. Un avertissement avant curseur détecte une qualité déjà réduite et ouvre une fois par session un dialogue qui nomme la source. Oui est sélectionné par défaut et poursuit la vérification ; Non ou Échap arrête cette vérification pour la source inchangée et enregistre le choix. La tonalité grave indique un signal avant curseur resté dans le rouge. La tonalité moyenne indique la zone de sortie jaune de la source focalisée. La tonalité aiguë indique une source focalisée dans le rouge ou un avertissement automatique de sortie. Le silence indique le vert, l’absence de signal ou de source focalisée. I contrôle les deux avertissements automatiques, pas les tonalités jaune et rouge de la console. Aucun historique ni rapport n’est enregistré.
