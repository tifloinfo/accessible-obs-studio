...
Le délai par défaut des avertissements automatiques est de 1,5 seconde et peut être modifié comme valeur décimale dans la fenêtre Accessible OBS Studio. Les avertissements de sortie évaluent le niveau après le curseur OBS. Les avertissements avant curseur concernent uniquement les entrées en direct, comme les microphones, cartes son et sons d’applications, et non les médias lus directement par OBS. Le dialogue demande s’il faut régler le niveau avant curseur. Non ou Échap désactive uniquement cette vérification ; les avertissements de sortie et les tonalités de la console restent actifs. Tant que la console de volume est ouverte, tous les avertissements automatiques et leurs compteurs sont suspendus ; seule la source focalisée produit des tonalités de mesure. La tonalité grave indique une entrée en direct rouge avant curseur ; la moyenne indique le jaune et l’aiguë le rouge de la source focalisée ou un avertissement de sortie.
