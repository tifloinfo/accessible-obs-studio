# Accessible Studio 1.1, version de test
...
**Outils > Accessible Studio > Outils audio > Paramètres audio avancés** permet de régler les avertissements de sortie. La **Liste d’arrêt avant curseur** contient les sources dont la vérification a été refusée. Sélectionnez une source et appuyez sur Suppr ou activez **Retirer** pour la vérifier à nouveau ; les modifications sont enregistrées avec OK.
