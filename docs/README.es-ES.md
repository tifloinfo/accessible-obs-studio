# Accessible Studio 1.1, versión de prueba
...
**Herramientas > Accessible Studio > Herramientas de audio > Configuración avanzada de sonido** permite configurar los avisos de salida. La **Lista de exclusión anterior al control** contiene las fuentes cuya comprobación se rechazó. Seleccione una fuente y pulse Supr o active **Quitar** para volver a comprobarla; los cambios se guardan al activar Aceptar.
