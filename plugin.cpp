...
static ApiKeyValidation ValidateApiKeyOnline(const std::string &key){
    HINTERNET session=WinHttpOpen(L"Accessible OBS Studio/1.0",WINHTTP_ACCESS_TYPE_AUTOMATIC_PROXY,WINHTTP_NO_PROXY_NAME,WINHTTP_NO_PROXY_BYPASS,0);if(!session)return ApiKeyValidation::ConnectionFailed;WinHttpSetTimeouts(session,10000,10000,10000,15000);
