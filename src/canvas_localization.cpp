...
static QString CText(CanvasText id){
    ...
    static const A text[]={
        ...
        A{"Analyze for Issues","Auf Probleme analysieren","Проверить на проблемы","Перевірити на проблеми","Analyser les problèmes","Analizar problemas"},
        ...
        A{"Analyze Again","Erneut analysieren","Проверить снова","Перевірити знову","Analyser à nouveau","Analizar de nuevo"},
        ...
        A{"No issues found","Keine Probleme gefunden","Проблемы не найдены","Проблем не знайдено","Aucun problème détecté","No se encontraron problemas"},
