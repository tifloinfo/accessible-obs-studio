...
static constexpr const char *ACCESSIBLE_OBS_BUILD_ID="1.0.7-build-20260728-1";
...
static void FrontendEvent(int event,void*){constexpr int PROFILE_CHANGED=15,FINISHED_LOADING=26;if(event==PROFILE_CHANGED||event==FINISHED_LOADING)QueueProfileReview();HandleAccessibilityFrontendEvent(event);}
