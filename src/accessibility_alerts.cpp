...
static void AnnounceAccessibility(const QString &message){
    if(!obsMainWindow||message.isEmpty())return;
    QAccessibleAnnouncementEvent event(obsMainWindow,message);
